...
public class AudioInfo {
    ...
    private static final int NUM_BITS_PER_BYTE = 8; // cria uma constante com o numero de bits em um byte
    ...
    public AudioInfo(AudioInputStream aiStream) {
        this.audioInputStream = aiStream; // recebe o audio como parametro
